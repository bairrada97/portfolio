...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    return this.$store.commit('getProject', this.project.id).then(next);
  },
};
</script>
...
.project {
    ...
    &:after {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(to top, $darkBlack 0%, transparent 50%);
    ...
    &:hover {
        ...
        -webkit-box-shadow: 11px 8px 20px 0 rgba(0,0,0,0.24);
        -moz-box-shadow: 11px 8px 20px 0 rgba(0,0,0,0.24);
